...
// CWebApplication properties can be configured here
	...
	$statusFlag=true;
	 ...
	 else
	 {
		...
		else if(strtolower($result['controller'])=='user' || strtolower($result['controller'])=='patient' )
		{
	...
	'params'=>array(
		...
		'base_path'=>'http://'.WEB_HOST_NAME.'/silkinventory/index.php?r=',
		'base_url'=>'http://'.WEB_HOST_NAME.'/silkinventory/',
		'base_path_language'=>'http://'.WEB_HOST_NAME.'/silkinventory/js/',
		'image_path'=>'http://'.WEB_HOST_NAME.'/silkinventory/images',
		'msg'=>$msg,
		'adminmsg'=>$adminmsg,
		'errorCode'=>$errorCode,
