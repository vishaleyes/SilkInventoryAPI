var TableAdvanced = function () {
	...
	var initTablePatientListForAdmin = function () {
		
        var table = $('#sample_patient_list_for_admin');
        ...
        var tableWrapper = $('#sample_patient_list_wrapper'); // datatable creates the table wrapper by adding with id {your_table_jd}_wrapper
	 ...
	 var initTablePatientList = function () {
		
        var table = $('#sample_patient_list');
	 ...
	 var initTableCholesterol = function () {
		
        var table = $('#sample_cholesterol');
        ...
        var tableWrapper = $('#sample_cholesterol_wrapper'); // datatable creates the table wrapper by adding with id {your_table_jd}_wrapper
    ...
    return {
        ...
        init: function () {
			...
			initTable5();
			initTable6();
			initTableCholesterol();
			initTablePatientList();
			initTablePatientListForAdmin();
