...
<?php if(isset(Yii::app()->session['pincab_patient']) && Yii::app()->session['pincab_patient']!='') { ?>
...
<!--                            echo Yii::app()->session['picture'];-->
 ...
 <?php if(isset(Yii::app()->session['pincab_patient']) && 
 Yii::app()->session['pincab_patient'] != "") { ?>
 </div>
    </div>
 	<!-- BEGIN FOOTER -->
    <div class="page-footer">
        <div class="page-footer-inner">
             <?php echo date("Y"); ?> &copy; Pin Cab.
        </div>
